function loadding(){
    ...
    <div class="logo">
      <img src="../img/logo/logo-manga-cosmos.png" alt="Logo">
    </div>
    <nav>
      <ul>
        ...
        <li><a href="INDEX.HTML">Sản Phẩm</a>
          <ul class="submenu">
            <li><a href="INDEX.HTML">Manga học đường</a></li>
            <li><a href="INDEX.HTML">Manga hoạt hình</a></li>
            <li><a href="INDEX.HTML">Shounen</a></li>
